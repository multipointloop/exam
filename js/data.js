...
const PRODUCTS = [
    ...
    },
    {
        ...
        image: 'images/products/baka-30元.jpg',
        description: '初音未来Q版手办，PVC材质，高约18cm。附带替换表情和专属底座，造型生动可爱，是V家粉丝的必收藏品。',
    ...
    },
    {
        ...
        originalPrice: 49.00,
        image: 'images/products/令泡泡-25元.jpg',
        description: '动漫主题陶瓷马克杯，容量350ml，高温烧制图案不掉色。适合日常饮用咖啡、茶或牛奶，微波炉和洗碗机均可使用。',
        specs: ['材质：陶瓷', '容量：350ml', '工艺：高温烧制', '包装：彩盒'],
        stock: 120,
        sales: 267,
        rating: 4.5,
        tags: ['实用'],
    ...
    },
    {
        ...
        originalPrice: 32.00,
        image: 'images/products/欧润吉-18元.jpg',
        description: '鬼灭之刃人气角色卡片合集，一套30张，采用烫金工艺。包含炭治郎、祢豆子、善逸等主要角色，背面为角色介绍。',
        specs: ['材质：铜版纸+烫金', '数量：30张/套', '尺寸：6×9cm', '包装：铁盒装'],
        stock: 85,
        sales: 534,
        rating: 4.7,
        tags: ['热卖', '推荐'],
    ...
    },
    {
        ...
        originalPrice: 55.00,
        image: 'images/products/夕泡泡-27元.jpg',
        description: '莉可丽丝主题手机壳，TPU+PC双层防护，图案高清不掉色。适配iPhone及主流安卓机型，下单请备注手机型号。',
        specs: ['材质：TPU+PC', '工艺：IMD模内注塑', '防护：防摔防刮', '备注：下单请备注型号'],
        stock: 60,
        sales: 178,
        rating: 4.6,
        tags: ['新品', '实用'],
    ...
    },
    {
        ...
        originalPrice: 60.00,
        image: 'images/products/小豆泥-47元.jpg',
        description: '间谍过家家安妮亚主题帆布袋，加厚16安帆布材质，尺寸35×40cm。环保又时尚，日常购物、上学、通勤的不二之选。',
        specs: ['材质：16安帆布', '尺寸：35×40cm', '工艺：丝网印刷', '包装：OPP袋'],
        stock: 95,
        sales: 312,
        rating: 4.8,
        tags: ['推荐', '实用'],
    ...
    },
    {
        ...
        originalPrice: 22.00,
        image: 'images/products/古明地恋-50元.jpg',
        description: '葬送的芙莉莲主题金属书签，一套4枚。不锈钢材质蚀刻图案，配有流苏吊坠，适合收藏或日常阅读使用。',
        specs: ['材质：不锈钢', '数量：4枚/套', '工艺：蚀刻+电镀', '配件：流苏吊坠'],
        stock: 180,
        sales: 421,
        rating: 4.7,
        tags: ['推荐'],
